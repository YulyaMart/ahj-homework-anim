...
export default class Colapsible {
  createCollapse() {
    const container = document.getElementById('container');
    const collaps = document.createElement('div');
    collaps.classList.add('collapsible-container');
    ...
    container.insertAdjacentElement('beforeend', collaps);
